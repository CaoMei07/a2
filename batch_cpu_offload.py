...
ds_config = {  
    "zero_optimization": {  
        ...
        "stage3_prefetch_bucket_size": int(5e6),  # 增加预取桶大小  
        "stage3_max_live_parameters": int(1e8),  # 增加活跃参数  
        "stage3_max_reuse_distance": int(1e8),   # 增加重用距离  
        "stage3_param_persistence_threshold": int(5e6),  # 降低持久化阈值  
        "overlap_comm": False  
    }
}
