...
ds_config = {  
    "zero_optimization": {  
        ...
        "stage3_prefetch_bucket_size": int(2e6),  # 增加预取桶大小  
...
with Init(remote_device="nvme", pin_memory=True, module=model, config_dict_or_path=ds_config, dtype=torch.half):  
