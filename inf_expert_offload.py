...
ds_config = {  
    "zero_optimization": {  
        ...
        "stage3_prefetch_bucket_size": int(8e7),  
        "stage3_max_live_parameters": int(5e10),  
        "stage3_max_reuse_distance": int(3e11),  
        "stage3_param_persistence_threshold": int(1e6),  
        "overlap_comm": False  
    }  
}
# 使用 Init 的 module 参数来转换已加载的模型  
with Init(remote_device="cpu", pin_memory=False, module=model, config_dict_or_path=ds_config):  
